...
import lion.favouritespots.FancyPlacesApplication;
import lion.favouritespots.R;
import lion.favouritespots.FancyPlace;
import lion.favouritespots.IMapHandler;
import lion.favouritespots.LocationHandler;
import lion.favouritespots.OsmMapHandler;
import lion.favouritespots.ScrollViewListener;
...
public class ShowEditPlace extends AppCompatActivity implements LocationHandler.OnLocationUpdatedListener {
    ...
    protected void onLocationChanged(int reason) {
        ...
        switch (reason) {
            case LOCATION_CHANGED_GPS:
                mapHandler.animateCamera(lat, lng, lion.favouritespots.FancyPlacesApplication.MAP_DEFAULT_ZOOM_NEAR, com.gabm.fancyplaces.FancyPlacesApplication.MAP_DEFAULT_DURATION);
                break;
            case LOCATION_CHANGED_USER:
                mapHandler.animateCamera(lat, lng, lion.favouritespots.FancyPlacesApplication.MAP_DEFAULT_DURATION);
                break;
            case LOCATION_CHANGED_INIT:
                mapHandler.setCamera(lat, lng, lion.favouritespots.FancyPlacesApplication.MAP_DEFAULT_ZOOM_NEAR);
                break;
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            ...
            currentState.data.getImage().scaleDown(lion.favouritespots.FancyPlacesApplication.TARGET_PIX_SIZE);
            currentState.image = currentState.data.getImage().loadFullSizeImage();
            onActivityModeChanged();
        }
    }
    ...
    protected void setMarker(double lat, double lng, String title) {
        ...
        mapHandler.animateCamera(lat, lng, lion.favouritespots.FancyPlacesApplication.MAP_DEFAULT_ZOOM_NEAR, lion.favouritespots.FancyPlacesApplication.MAP_DEFAULT_DURATION);
    }
