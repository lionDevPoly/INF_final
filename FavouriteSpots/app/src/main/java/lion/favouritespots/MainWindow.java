...
public class MainWindow extends AppCompatActivity implements OnFancyPlaceSelectedListener, IOnListModeChangeListener {
    ...
    protected void setDefaultTitle() {
        String debugTitle = getResources().getString(R.string.title_activity_list_fancy_places);
    ...
    protected void copyImageToTmp(FancyPlace fp) {
        ...
        if (fp.getImage().exists()) {
            ...
            fp.setImage(curState.OriginalImageFile.copy(lion.favouritespots.FancyPlacesApplication.TMP_IMAGE_FULL_PATH));
        } else {
            curState.OriginalImageFile = null;
            fp.setImage(new ImageFile(lion.favouritespots.FancyPlacesApplication.TMP_IMAGE_FULL_PATH));
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_SHOW_EDIT_PLACE) {
            ...
            (new ImageFile(lion.favouritespots.FancyPlacesApplication.TMP_IMAGE_FULL_PATH)).delete();
